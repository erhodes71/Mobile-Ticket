//
//  SubmitToGeneralQueueViewController.swift
//  SidebarMenu
//
...
class SubmitToGeneralQueueViewController: UIViewController{
    ...
    @IBOutlet var submitToGeneralQueueText: UILabel!
    ...
    override func viewDidLoad() {
        ...
        if UIDevice().userInterfaceIdiom == .phone {
            ...
            case 2436:
                print("iPhone X")
                submitToGeneralQueueText.isHidden = true
            default:
                print("unknown")
            }
        }
